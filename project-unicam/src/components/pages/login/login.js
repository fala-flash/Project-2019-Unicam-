...
class Login extends Component {
  ...
  addUser() {
    fire
      .database()
      .ref(this.state.tipo + "/" + this.state.user.uid)
      .set({
        nome: "",
  ...
  addUserGoogle() {
    ...
    rootUtente.on("value", snap => {
      ...
      if (snap.val() === null) {
        ...
        fire
          .database()
          .ref("Utente/" + this.state.user.uid)
          .set({
...
/* 
  getUserType() {
    ...
    const rootPsicologo = fire
      .database()
      .ref("Psicologo/" + this.state.user.uid);
  ...
  formRegistrazione() {
    return (
      <div>
        <Form
          className="formLogin"
          onSubmit={event => this.registraEmailPassword(event)}
        >
          <Form.Group controlId="formBasicEmail">
            <Form.Label>Email</Form.Label>
            <Form.Control
              ...
              placeholder="Inserisci Email"
              ref={input => {
                this.emailInputRegistrazione = input;
              }}
            />
          </Form.Group>
          <Form.Group controlId="formBasicPassword">
            ...
            <Form.Control
              ...
              placeholder="Inserisci Password"
              ref={input => {
                this.passwordInputRegistrazione = input;
              }}
            />
          </Form.Group>
          <Form.Group controlId="formBasicChecbox" />
          <Form.Group controlId="exampleForm.ControlSelect1">
            ...
            <Form.Control
              ...
              as="select"
              ref={input => {
                this.tipoInputRegistrazione = input;
              }}
            >
      ...
      <div className="loginStyle">
        ...
        <Button
          ...
          onClick={() =>
            this.setState({
              openAccesso: false,
              openRegistrazione: !openRegistrazione
            })
          }
